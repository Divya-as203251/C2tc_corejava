...
public Certificate(int id, String name, String college, int roll, String qualification, String course, int year,
...
public String toString() {
	return "Certificate [id=" + id + ", name=" + name + ", college=" + college + ", roll=" + roll + ", qualification="
			+ qualification + ", course=" + course + ", year=" + year + ", certificate=" + certificate
			+ ", hallticketnum=" + hallticketnum + "]";
}
